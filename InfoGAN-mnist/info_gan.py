...
Original file is located at
    https://colab.research.google.com/drive/1TdtzXSBYLpn4yS17GydJ3g96ycXdaZgA
"""
...
#Loading the training dataset and reshaping it.
...
#importing the models defined in gan.py submodule
...
#creating a saver to store the model checkpoints as training goes ahead per epoch
...
#takes different samples and as training progresses saves the image generated
#by the generator at that instant from the predictions
def train_display_image(model, epoch):
    ...
    plt.savefig('img_step{:04d}.png'.format(epoch))
    plt.close()

#Defininig the discriminator loss
...
#calculate the mutual information criterior for Info gan and return info-loss
...
#sample or control input to perform variations in the end of training
...
#training step which computes gradient and updates the losses for all 3 models
...
#save checkpoint epoch wise and maintain empty list to plot losses of both
#generator and discriminator, saves the plot after training in local dir
def train(dataset, epochs):
    ...
    plt.savefig("GAN loss",dpi=1000)

if __name__ == "__main__":
  train(dataset,epochs=60)